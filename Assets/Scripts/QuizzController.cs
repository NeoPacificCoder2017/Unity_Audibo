...
public class QuizzController : MonoBehaviour {
    ...
    {
        "Question 1,1-a", "Question 2,1-tristesse", "Question 3,2-b", "Question 4,2-svp", "Question 5,3-c", "Question 6,3-merci", "Question 7,4-aide", "Question 8,4-d", "Question 9,5-amour",
        "Question 10,5-e", "Question 11,6-f", "Question 12,6-pardon", "Question 13,7-g", "Question 14,7-père", "Question 15,8-h", "Question 16,8-mère", "Question 17,9-coiffeur",
        "Question 18,9-i", "Question 19,10-faire", "Question 20,10-j"
    };
    ...
    private void InitQuizzQuestions()
    {
        ...
        foreach (var i in indexQuestion)
        {
            str = allQuestions[i].Split(',');
            quizzQuestions.Add(new QuestionModel(str[0], str[1], true, i));
        }
    ...
    private void DisplayQuestion()
    {
        ...
        answerImg1.texture = Resources.Load(string.Concat("Images/", quizzQuestions[indexRound].selections[0].text)) as Texture;
        answerImg2.texture = Resources.Load(string.Concat("Images/", quizzQuestions[indexRound].selections[1].text)) as Texture;
    }

    //public int OnAnswerClick(int aTag)
    //{
    //    //
    //}
}
